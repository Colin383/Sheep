...
namespace BPGame
{
    [UIViewAttribute(UILayer.BaseLayer, "Assets/BPGame/Bundles/UI/LaunchPageView.prefab", false)]
    public class LaunchPageView : UIView
    {
		...
		protected override void ScriptGenerator()
		{
			...
			btn_start = FindChildComponent<Button>("root/btn_start");
		}
        ...
        {
        	return new LaunchPageLogic(this);
        }
        ...
        {
            base.AddEvent();
            btn_start.onClick.AddListener(OnClickStartEvent);
        }
